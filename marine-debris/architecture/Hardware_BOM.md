...
Shared cart is the same family as `ideas-20/architecture_shared_en.md`.
...
Official shops (bookmark): Espressif 乐鑫, Hi-Link 海凌科, Seeed 矽递 — same links as the old bollard BOM.
