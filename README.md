# COMP5047 / COMP4447 — project ideas (phone)

Private pack for the group. **Start here on a phone.**

## Read these first (source-backed ideas)

1. **English:** [ideas-20/from-sources_en.md](ideas-20/from-sources_en.md)
2. **中文:** [ideas-20/from-sources_cn.md](ideas-20/from-sources_cn.md)

Tap a file → GitHub renders the Markdown. Rotate to portrait; tables scroll sideways.
